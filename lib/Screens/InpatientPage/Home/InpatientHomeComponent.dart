...
//     Consumer<News2>(builder: (context, valor, child) {
//       switch (cardCase) {
//         case "respiratoryFreq":
//           icon = Image.asset('assets/images/respiratoryFreq.png',
//               height: 40, width: 40);
//           valor.setRespiratoryFreq(34);
//           break;
//         case "bloodPressure":
//           icon = Image.asset('assets/images/bloodPressure.png',
//               height: 32, width: 32);
//           valor.setRespiratoryFreq(23);
//           break;
//         case "pulse":
//           icon = Image.asset('assets/images/pulse.png', height: 40, width: 40);
//           valor.setRespiratoryFreq(70);
//           break;
//         case "conscience":
//           icon = Icon(Icons.face, size: 32);
//           valor.setRespiratoryFreq(12);
//           break;
//         case "temperature":
//           icon = Image.asset('assets/images/temperature.png',
//               height: 40, width: 40);
//           valor.setRespiratoryFreq(67);
//           break;
//         case "sp":
//           icon = Icon(Icons.air, size: 32);
//           valor.setRespiratoryFreq(34);
...
//               padding: const EdgeInsets.all(8),
//               child:
//                   Consumer<News2>(builder: (context, val, child) {
//                   switch (cardCase) {
//                     case "respiratoryFreq":
//                       return Text(val.toStringRespiratoryFreq());
//                       break;
