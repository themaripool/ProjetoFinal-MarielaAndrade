      ...
      child: Row(
        ...
        children: [
          Row(children: [
            ...
            Text("60 bpm", style: TextStyle(fontSize: 14))
          ]),
          Row(children: [
            Text("Temp: ",
                style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.bold)),
            Text("36.1 C", style: TextStyle(fontSize: 14))
          ]),
          Row(children: [
            Text("FR: ",
                style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.bold)),
            Text("12pm", style: TextStyle(fontSize: 14))
          ]),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(" 79%", style: TextStyle(fontSize: 18)),
